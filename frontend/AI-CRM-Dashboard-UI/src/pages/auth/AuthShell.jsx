import {Sparkles, TrendingUp, Bot, SheildCheck} from 'lucide-react';

export function AuthSheel({children}) {
    return (
                ...
                <div className='absolute -right-24 -top-24 h-80 w-80 rounded-full bg-brand-500/40 blur-3xl'/>
                    ...
                    <div className='relative'>
                        <h2 className='font-display text-4xl font-bold leading-tight'>
                            Close more deals with an AI co-pilot in your piplines.
                        </h2>
                        <p className='mt-4 max-w-md text-white/70'>
                        TTP CRM unifies your leads, contacts and follow-ups -- then layers Gemini-powered summaries, emaildrafts and sales insights on top.</p>
                        <div className='mt-10 space-y-4'>
                            {[
                                {icon:TrendingUp,text: "Visual pipline with drag-and-drop stages"},
                                {icon:Bot, text:"AI lead scoring & instant email drafting"},
                                {icon:SheildCheck, text:"Secure JWT auth,your data stays yours"},
                            ].map(({icon: Icon, text})=>(
